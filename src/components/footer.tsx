                ...
                <div className="flex flex-col items-center justify-between space-y-4 pt-6 sm:space-y-0">
                    ...
                    <div className="flex items-center space-x-4" aria-label="Media społecznościowe">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="rounded-md p-1 text-gray-600 transition-colors hover:text-[#E4405F] focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:ring-offset-2 dark:text-gray-400 dark:hover:text-[#E4405F]"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="rounded-md p-1 text-gray-600 transition-colors hover:text-[#000000] focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:ring-offset-2 dark:text-gray-400 dark:hover:text-[#FFFFFF]"
                            aria-label="TikTok"
                        >
                            <svg className="size-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
