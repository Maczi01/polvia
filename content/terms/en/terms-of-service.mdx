...
(This Privacy Policy defines the rules for processing and protecting personal data of Users of the [polvia](https://www.polvia.pl) service, operated by Polvia, email: [polvia.services@gmail.com](mailto:polvia.services@gmail.com). Using the service means acceptance of the following provisions.)

## 1. Definitions

**Administrator** - the entity operating the [polvia](https://www.polvia.pl) service, i.e. Polvia, email: [polvia.services@gmail.com](mailto:polvia.services@gmail.com).
