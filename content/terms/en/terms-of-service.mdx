...
(This Privacy Policy defines the rules for processing and protecting personal data of Users of the [pol.ie](https://www.pol.ie) service, operated by Mateusz Twardy, email: [info@pol.ie](mailto:info@pol.ie). Using the service means acceptance of the following provisions.)

## 1. Definitions

**Administrator** - the natural person operating the [pol.ie](https://www.pol.ie) service, i.e. Mateusz Twardy, email: [info@pol.ie](mailto:info@pol.ie).

**Service** - the website [pol.ie](https://www.pol.ie), serving to present Polish businesses operating in Ireland, with functionality for adding business entries via email and newsletter subscription.
...
To add or modify business data, the User sends an email to [info@pol.ie](mailto:info@pol.ie) with relevant information (email-based "submission form"). The Administrator verifies the submitted information (whether the business exists, whether data is complete) and decides on publication.
...
For questions regarding personal data protection, please contact: [info@pol.ie](mailto:info@pol.ie).
...
Thank you for reviewing our Privacy Policy. For additional questions or concerns, contact us at [info@pol.ie](mailto:info@pol.ie).