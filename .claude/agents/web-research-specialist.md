...
user: "Dostaję błąd 'Module not found' po aktualizacji Next.js, pomożesz to zdebugować?"
...
user: "Scope: prior art + wzorce konkurencji. Budujemy system powiadomień na Server Actions i Postgresie."
