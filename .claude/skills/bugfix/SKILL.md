---
name: bugfix
description: "Systematyczna naprawa bugow w dzialajcej aplikacji. Uzywaj przy bledach z logow (Vercel / dev server / konsola przegladarki), failujacych E2E, zgloszeniach userow, nieoczekiwanym zachowaniu po uzyciu. Wywoluj przez /bugfix [opis bugu]."
argument-hint: "[opis bugu lub fragment logu]"
---

# Bugfix — systematyczna naprawa bugow

Skill do naprawy bugow wykrytych w dzialajcej aplikacji — logi (Vercel / dev server / konsola przegladarki), E2E failures, zgloszenia userow, nieoczekiwane zachowanie. UWAGA: to repo NIE ma Sentry ani innego error trackingu — zrodlem sygnalu sa logi i reprodukcja lokalna.
...
1. **Zrodlo bugu:** logi (Vercel / dev server / konsola) / E2E test / manual / zgloszenie usera
2. **Priorytet:**
...
4. **Sprawdz baze wiedzy:**
   ...
   - Sprawdz logi i git log — czy to regresja (kiedy zaczelo sie pojawiac, ktory deploy/commit)
...
1. **Zbierz kontekst:**
   - Logi: error message, stack trace, URL/route, locale, deploy (Vercel) lub commit
...
1. Jesli bug dotyczyl produkcji — po deploy'u fixa:
   - Sprawdz logi po deployu — blad przestal sie pojawiac?
